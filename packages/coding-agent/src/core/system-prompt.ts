...
export function buildSystemPrompt(options: BuildSystemPromptOptions = {}): string {
	...
	// Get absolute path to core documentation
...
- For implementation details, inspect source code in packages/coding-agent/src, packages/ai/src, and packages/tui/src
- When working on pi topics, prefer source code and available markdown files over assumptions`;
